...
struct Dopr853_constants {
  ...
  static const Doub c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c14, c15, c16, b1,
      b6, b7, b8, b9, b10, b11, b12, bhh1, bhh2, bhh3, er1, er6, er7, er8, er9,
      er10, er11, er12, a21, a31, a32, a41, a43, a51, a53, a54, a61, a64, a65,
      a71, a74, a75, a76, a81, a84, a85, a86, a87, a91, a94, a95, a96, a97, a98,
      a101, a104, a105, a106, a107, a108, a109, a111, a114, a115, a116, a117,
      a118, a119, a1110, a121, a124, a125, a126, a127, a128, a129, a1210, a1211,
      a141, a147, a148, a149, a1410, a1411, a1412, a1413, a151, a156, a157,
      a158, a1511, a1512, a1513, a1514, a161, a166, a167, a168, a169, a1613,
      a1614, a1615, d41, d46, d47, d48, d49, d410, d411, d412, d413, d414, d415,
      d416, d51, d56, d57, d58, d59, d510, d511, d512, d513, d514, d515, d516,
      d61, d66, d67, d68, d69, d610, d611, d612, d613, d614, d615, d616, d71,
      d76, d77, d78, d79, d710, d711, d712, d713, d714, d715, d716;
};
...
struct StepperDopr853 : StepperBase, OP, Dopr853_constants {
  ...
  void prepare_dense(const Doub h, Dopr853DenseData &dense_data);
 ...
 * FSAL. */
template <class D, typename OP>
void StepperDopr853<D, OP>::step(const Doub htry, D &derivs) {
  Doub h = htry;
  for (;;) {
    dy(h, derivs);
    Doub err = error(h);
...
template <class D, typename OP>
void StepperDopr853<D, OP>::dy(const Doub h, D &derivs) {
  VecDoub ytemp(n);
  Int i;
...
template <class D, typename OP>
void StepperDopr853<D, OP>::prepare_dense(const Doub h,
...
template <class D, typename OP>
Doub StepperDopr853<D, OP>::dense_out(
    const Int i, const Doub x, const Doub h,
    Dopr853DenseData const &dense_data) const {
  Doub s = (x - (StepperBase::x - h)) / h;
  Doub s1 = 1.0 - s;
...
template <class D, typename OP>
Doub StepperDopr853<D, OP>::error(const Doub h) {
...
template <class D, typename OP>
bool StepperDopr853<D, OP>::Controller::success(const Doub err, Doub &h) {
  /* Same controller as StepperDopr5 except different values of the constants.
   */
  static Doub constexpr beta = 0.0, alpha = 1.0 / 8.0 - beta * 0.2, safe = 0.9,
                        minscale = 0.333, maxscale = 6.0;
  Doub scale;
  if (err <= 1.0) {
    if (err == 0.0)
      scale = maxscale;
