...
TEST(ODEIntegratorTest, VanDerPolTest)
{
    ...
    constexpr auto reference_x_values = std::array{ 0.0, 0.1, 0.2, 0.30000000000000004, 0.4, 0.5, 0.6,
    ...
    constexpr auto reference_y0_values = std::array{ 2.0, 1.9316114668840196, 1.8584936578161697,
    ...
    constexpr auto reference_y1_values = std::array{ 0.0, -0.70723585006735, -0.7569013815134848,
...
TEST(ODEIntegratorTest, SimpleOscillatorTest)
{
    ...
    constexpr auto reference_x_values = std::array{ 0.0, 0.1, 0.2, 0.30000000000000004, 0.4, 0.5, 0.6,
        ...
        1.3, 1.4000000000000001, 1.5000000000000002, 1.6000000000000003, 1.7000000000000004,
        1.8000000000000005, 1.9000000000000006, 2.0 };
    constexpr auto reference_y0_values = std::array{ 1.0, 0.995004165274381, 0.9800665778342761,
    ...
    constexpr auto reference_y1_values = std::array{ 0.0, -0.09983341667072441, -0.19866933081341775,
